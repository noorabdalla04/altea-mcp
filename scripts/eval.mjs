...
const EV = { instructor: process.env.ALTEA_EVAL_INSTRUCTOR || 'omar', klass: process.env.ALTEA_EVAL_CLASS || 'hot yin', courts: process.env.ALTEA_EVAL_COURTS || 'courts', typo: process.env.ALTEA_EVAL_TYPO || 'omer' };
